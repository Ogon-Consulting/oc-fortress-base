...
public class PersonalAutoHandler {

    private static String personalAutoTestSuiteResult = StaticVariables.EXECUTION_SUCCESS;
    ...
    private static Map<String,Map<String, Map<String, ArrayList<String>>>> testData = new HashMap<>();

    public static String executePersonalAutoTestSuite(InputData inputData) {
        try {
            initializeFields();
            ...
            testData = processInputTestData(inputData.getTestData());
            ...
            UIFieldTestDataMapService uiFieldTestDataMapService = appCtx.getBean("UIFieldTestDataMapService", UIFieldTestDataMapService.class);
            Date date = new Date();
            ...
            if (execute_TC_ADD_CUSTOMER || !isCustomerExistsAlready){
                List<TestDataEntity> custTestDataFromDB = uiFieldTestDataMapService.fetchTestDataByTestCase(AppVariables.ADD_CUSTOMER);
                Map<String, Map<String, ArrayList<String>>> custTestDataFromUser;
                custTestDataFromUser = testData.get(AppVariables.ADD_CUSTOMER);
                ...
                if (execute_TC_ADD_CUSTOMER && addCustomerResultList != null && !addCustomerResultList.isEmpty() && addCustomerResultList.size() > 1) {
                    ...
                    saveTestResult(addCustomerResultList.get(1), StaticVariables.TX_ADD_CUSTOMER, "TC_ADD_CUSTOMER", executionResult);
                }
            }
...
//                    providerNumber = producerCd;
//                }
//                List<UIFieldTestDataMapEntity> quoteTestDataFromDB = uiFieldTestDataMapService.fetchTestDataByTestCase(AppVariables.ADD_QUOTE);
//                Map<String, Map<String, ArrayList<String>>> quoteTestData;
//                quoteTestData = testData.get(AppVariables.ADD_QUOTE);
//                addQuoteResultList = executeAddQuoteTestCase(providerNumber, firstName, lastName, quoteTestData, quoteTestDataFromDB);
...
//            }
//
//            if (execute_TC_NB || otherTestCasesAvailable) {
...
//                } else if (otherTestCasesAvailable) {
//                    assert newBusinessResultList != null;
//                    policyNumber = newBusinessResultList.get(1);
//                }
//            }
//
...
//    public static List<String> executeAddQuoteTestCase(String providerNumber, String firstName, String lastName, Map<String, Map<String, ArrayList<String>>> quoteTestData, List<UIFieldTestDataMapEntity> quoteTestDataFromDB) {
//        long startTime = System.currentTimeMillis();
//        //List<String> addQuoteResultList = AddQuote.addNewQuote(carrierId, product, stateCd, effectiveDt, providerNumber, firstName, lastName, quoteTestData, quoteTestDataFromDB);
...
//    }
    ...
    private static void saveTestResult(String policyNumber, String transactionCd, String testCaseId, String testResult) {
        ...
        testResultEntity.setTestStatus(personalAutoTestSuiteResult);
        testResultEntity.setJobId(jobId);
        testResultService.saveTestResults(testResultEntity);
    }

    private static Map<String,Map<String, Map<String, ArrayList<String>>>> processInputTestData(String testData) {
        try {
            ...
            for(int testCaseIndex = 0; testCaseIndex < testCaseJSONArray.length(); testCaseIndex++){
                ...
                for(int menuIndex=0; menuIndex < menuJSONArray.length(); menuIndex++) {
                    ...
                    for(int fieldIndex=0; fieldIndex < fieldsJSONArray.length(); fieldIndex++) {
                        ...
                        fieldTestDataMap.put(jsonFieldObject.getString("label"),fieldTestDataList);
                    }
