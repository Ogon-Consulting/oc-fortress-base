...
import com.ogon.umv.product.personalauto.pages.quote.PaymentPlan;
...
public class Application {
    ...
    public static List<String> processApplication(){
        try {
            ...
            processApplicationResult = DwellingQuestions.fillDwellingQuestions();

            $(byId("Wizard_BillPayPlan")).shouldBe(enabled).click();
            processApplicationResult = PaymentPlan.fillPaymentPlanTab();
