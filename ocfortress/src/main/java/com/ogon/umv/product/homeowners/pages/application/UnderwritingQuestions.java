...
public class UnderwritingQuestions {
    ...
    public static List<String> fillUnderwritingTab(){
        ...
        try {
            ...
            $(byId("Question_OtherResidence")).shouldBe(visible, editable).selectOptionByValue("NO");
            $(byId("Question_OtherInsWithCo")).shouldBe(visible, editable).selectOptionByValue("NO");
            $(byId("Question_PriorCarrier")).shouldBe(visible, editable).selectOptionByValue("No Prior");
